...
# output copy
xrdcp -f outputs/*.log root://eosuser.cern.ch//eos/user/a/abulla/CMSSW_14_0_21/src/dyturbo-1.4.2-empire/DYZ/DYTurbo-results/testWp2D_7G/outputs/ \
|| exit 1

xrdcp -f outputs/*.txt root://eosuser.cern.ch//eos/user/a/abulla/CMSSW_14_0_21/src/dyturbo-1.4.2-empire/DYZ/DYTurbo-results/testWp2D_7G/outputs/ \
|| exit 1